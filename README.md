...
```
wget -O install_exporters.sh https://raw.githubusercontent.com/pramonoutomo/cosmos_node_monitoring/master/install_exporters.sh && chmod +x install_exporters.sh && ./install_exporters.sh
```
...
```
wget -O install_monitoring.sh https://raw.githubusercontent.com/pramonoutomo/cosmos_node_monitoring/master/install_monitoring.sh && chmod +x install_monitoring.sh && ./install_monitoring.sh
```
